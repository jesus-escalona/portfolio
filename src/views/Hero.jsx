...
const Hero = ({ children, offset }) => (
  <>
    <Divider speed={0.2} offset={offset}>
      <UpDown>
        <SVG icon="triangle" hiddenMobile width={48} stroke={colors['app-orange']} left="10%" top="20%" />
        <SVG icon="hexa" width={48} stroke={colors['app-red']} left="60%" top="70%" />
        <SVG icon="box" width={6} fill={colors['grey-darker']} left="60%" top="15%" />
      </UpDown>
      <UpDownWide>
        <SVG icon="arrowUp" hiddenMobile width={16} fill={colors['app-blue']} left="80%" top="10%" />
        ...
        <SVG icon="cross" width={16} stroke={colors['app-pink']} left="28%" top="15%" />
      ...
      <SVG icon="circle" width={64} fill={colors['app-dark-green']} left="95%" top="5%" />
      <SVG icon="box" hiddenMobile width={64} fill={colors['app-blue']} left="5%" top="90%" />
