...
{/*    <DividerMiddle
    ...
    <Divider speed={0.1} offset={offset} factor={2}>
      <UpDown>
        ...
        <SVG icon="triangle" width={8} stroke={colors['app-orange']} left="25%" top="5%" />
        <SVG icon="circle" hiddenMobile width={24} fill={colors.white} left="17%" top="60%" />
      </UpDown>
      <UpDownWide>
        <SVG icon="arrowUp" hiddenMobile width={16} fill={colors['app-green']} left="20%" top="90%" />
        ...
        <SVG icon="upDown" hiddenMobile width={8} fill={colors['app-green']} left="45%" top="10%" />
      </UpDownWide>
      <SVG icon="circle" width={6} fill={colors.white} left="4%" top="20%" />
      <SVG icon="circle" width={12} fill={colors['app-pink']} left="80%" top="60%" />
      <SVG icon="box" width={6} fill={colors['app-orange']} left="10%" top="10%" />
      <SVG icon="box" width={12} fill={colors.yellow} left="29%" top="26%" />
      <SVG icon="hexa" width={16} stroke={colors['app-red']} left="75%" top="30%" />
